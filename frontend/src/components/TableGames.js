    ...
    return (
        <div>  <div>
            ...
            <div className='flex justify-between'>
                <p className='font-medium flex gap-2 text-yellow-400 items-center mt-4 text-lg'> <img className='size-4' src='/table.png' />Table Games</p>
            ...
            <div className='flex mt-2 overflow-x-auto scrollbar-hide gap-4 '>
                ...
                <Link to="#" className="relative flex flex-col items-center justify-center group">
                    ...
                    {/* Below Image Text */}
                    <p className="font-medium text-base"> Andar Bahar</p>
                </Link>
                ...
                <Link to="#" className="relative flex flex-col items-center justify-center group">
                    ...
                    {/* Below Image Text */}
                    <p className="font-medium text-base">Coin Toss</p>
                </Link>
