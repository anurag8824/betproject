...
const Footer = () => {
  ...
  return (
    <>
      {/* Footer Component */}
      <footer className="bg-black hidden overflow-hidden">
            ...
            <div className="xl:col-span-3 lg:col-span-4 md:col-span-6 mb-10 xl:mb-0 xl:pl-10">
              ...
              {footerCandidate.map((item, index) => (
                <Link href={item.link} key={index}>
                  <a className="text-xs text-white  font-normal leading-6 mb-4 block transition-all duration-300 hover:text-themePrimary">
                    {item.name}
                  </a>
                </Link>
              ))}
